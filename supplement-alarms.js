...
const ALARMS = [
  ...
  { hour: 10, minute: 0,  text: '🌅 10:00 AM — BREAKING THE FAST\nOmega-3 Fish Oil · Amla 500mg (Dose 1) · Curcumin+Piperine 500mg · D3+K2\nEat with high-fat meal: Eggs + Avocado. Curcumin is fat-soluble — needs the lipid vehicle.' },
  ...
  { hour: 20, minute: 0,  text: '🌙 8:00 PM — DINNER & 14-HOUR FAST BEGINS\nAshwagandha KSM-66 300–600mg with dinner\nBlunts cortisol, preps sleep architecture. Fast starts now — water/herbal tea only until 10 AM.' },
];
